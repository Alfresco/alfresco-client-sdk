...
{
    @SerializedName("isThumbnailGenerationEnabled")
    ...
    public void setIsThumbnailGenerationEnabled(Boolean thumbnailGenerationEnabled)
    {
        isThumbnailGenerationEnabled = thumbnailGenerationEnabled;
    }
