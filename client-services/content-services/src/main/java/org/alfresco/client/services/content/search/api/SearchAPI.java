...
import org.alfresco.client.services.content.search.SearchConstant;
import org.alfresco.client.services.content.search.body.QueryBody;
...
public interface SearchAPI
{
     ...
     */
    @POST(SearchConstant.SEARCH_PUBLIC_API_V1 + "/search")
    Observable<ResultSetRepresentation<ResultNodeRepresentation>> searchObservable(@Body QueryBody queryBody);
