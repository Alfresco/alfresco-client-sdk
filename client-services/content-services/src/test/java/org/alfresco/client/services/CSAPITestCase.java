...
public abstract class CSAPITestCase extends AlfrescoAPITestCase
{
    // ///////////////////////////////////////////////////////////////////////////
    // VARIABLES
    // ///////////////////////////////////////////////////////////////////////////
    ...
    {
        client = new CSClient.Builder().connect("http://cmis.alfresco.com/", "admin", "admin")
                .httpLogging(HttpLoggingInterceptor.Level.BODY).build();
    }

    public CSClient prepareClient(String endpoint, String username, String password)
    {
        return new CSClient.Builder().connect(endpoint, username, password)
                .httpLogging(HttpLoggingInterceptor.Level.BODY).build();
    }

    // TODO Design it better.
    public CSClient prepareClientTicket(String endpoint, String ticket)
    {
        return new CSClient.Builder().connectWithTicket(endpoint, ticket).httpLogging(HttpLoggingInterceptor.Level.BODY)
                .build();
    }
