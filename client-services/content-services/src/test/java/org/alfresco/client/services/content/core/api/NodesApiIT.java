...
import org.alfresco.client.services.utils.IOUtils;
import org.alfresco.client.services.utils.NodeRefUtils;
...
public class NodesApiIT extends CSAPITestCase
{
    // ///////////////////////////////////////////////////////////////////////////
    // CONSTANTS
    // ///////////////////////////////////////////////////////////////////////////
    ...
    public void folderLifeCycleTests() throws IOException
    {
        ...
        // Assert.assertEquals(nodesResponse.getCount(), 7, "Pagination Total
        // items is wrong. Stale state ?");
    ...
    {
        // Prepare
        FolderRepresentation root = (FolderRepresentation) createRootTestFolder();
        NodesAPI nodeService = client.getAPI(NodesAPI.class);
        ...
        // Create Body
        File file = getResourceFile("/org/alfresco/client/api/tests/test.txt");
        ...
        Response<NodeRepresentation> createdNodeResponse = nodeService
                .createNodeCall(root.getId(), fileRequestBody).execute();
        ...
        // Check Response
        FileRepresentation testNode = (FileRepresentation) createdNodeResponse.body();
        ...
        // Create Body
        checkResourceFile("/org/alfresco/client/api/tests/test2.txt");
        file = getResourceFile("/org/alfresco/client/api/tests/test2.txt");
        ...
        // Check Response
        FileRepresentation nodeUpdatedResponse = (FileRepresentation) updateNodeResponse.body();
        ...
        // COPY
        NodeBodyCreate request = new NodeBodyCreate("Test", "cm:folder");
        NodeRepresentation testFolder = nodeService.createNodeCall(root.getId(), request).execute().body();
