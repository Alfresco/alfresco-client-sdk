...
public interface HistoryAPI
{
    ...
    Call<Void> deleteHitoricProcessInstance(@Path("processInstanceId") String processInstanceId);
    ...
    Call<ResultList<HistoricActivityInstanceResponse>> getHistoricActivityInstances(
    ...
    Call<ResultList<HistoricVariableInstanceResponse>> getHistoricVariableInstances(
    ...
    Call<ResultList<HistoricTaskInstanceResponse>> queryHistoricTaskInstance(
            @Body HistoricProcessInstanceQueryRequest body);
