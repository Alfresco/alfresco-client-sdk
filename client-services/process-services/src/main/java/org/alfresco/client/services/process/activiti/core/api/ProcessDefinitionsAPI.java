...
public interface ProcessDefinitionsAPI
{
    ...
    Call<RestIdentityLink> createIdentityLink(@Path("processDefinitionId") String processDefinitionId,
    ...
    Call<Void> deleteIdentityLink(@Path("processDefinitionId") String processDefinitionId,
    ...
    Call<RequestBody> getModelResource(@Path("processDefinitionId") String processDefinitionId);
