...
public interface ProcessInstancesAPI
{
    ...
    Call<List<RestVariable>> createOrUpdateProcessVariable(@Path("processInstanceId") String processInstanceId);
    ...
    Call<ProcessInstanceResponse> createProcessInstance(@Body ProcessInstanceCreateRequest body);
