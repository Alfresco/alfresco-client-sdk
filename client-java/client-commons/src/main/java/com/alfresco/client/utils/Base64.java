...
public final class Base64
{
    ...
    public static byte[] decode(byte[] source, int off, int len, int options) throws IOException
    {
        ...
        if (source == null) { throw new NullPointerException("Cannot decode null source array."); } // end
                                                                                                    // if
        if (off < 0 || off + len > source.length) { throw new IllegalArgumentException(
                String.format("Source array with length %d cannot have offset of %d and process %d bytes.",
                        source.length, off, len)); } // end
                                                     // if
    ...
    public static byte[] decodeFromFile(String filename) throws IOException
    {
        ...
        try
        {
            ...
            if (file.length() > Integer.MAX_VALUE) { throw new IOException(
     ...
     *
     * @param closeable the {@link Closeable} object
     */
    ...
    public static class OutputStream extends java.io.FilterOutputStream
    {
        ...
        public void write(int theByte) throws IOException
        {
            ...
            else
            {
                ...
                else if (decodabet[theByte
                        & 0x7f] != WHITE_SPACE_ENC) { throw new IOException("Invalid character in Base64 data."); } // end
                                                                                                                    // else:
                                                                                                                    // not
                                                                                                                    // white
                                                                                                                    // space
